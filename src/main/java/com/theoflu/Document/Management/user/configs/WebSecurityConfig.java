...
import com.theoflu.Document.Management.user.service.LogoutService;
import com.theoflu.Document.Management.user.service.impl.UserDetailsServiceImpl;
                        ...
                        auth.requestMatchers("/api/auth/**").permitAll().
                            requestMatchers("/api/auth/signUp").permitAll()
                               ...
                               // .requestMatchers("/api/user/upload").hasRole("Admin")
                                //.requestMatchers("/api/user/upload").hasRole("Ad")
                                //.requestMatchers("/api/user/upload").hasRole("Document_Manager")
